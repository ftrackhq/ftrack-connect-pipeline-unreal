...
class UnrealOpenerContextPlugin(plugin.OpenerContextPlugin, UnrealBasePlugin):
...
class UnrealOpenerContextPluginWidget(
    pluginWidget.OpenerContextPluginWidget, UnrealBasePluginWidget
):
